...
Page({
    ...
    onLoad: function (e) {
        var n = wx.getStorageSync("kejiaPlaySet");
        this.setData({
    ...
    visited: function (a) {
        var t = this,
            e = a.currentTarget.dataset.frienduid;
        wx.redirectTo({
    ...
    animalDetail: function (a) {
        var t = [a.detail, this.data.animalList],
            e = t[0],
            n = t[1].find(function (a) {
                return a.id === e
            });
        this.setData({
            currentInfo: n
    ...
    joinBag: function () {
        var e = this,
            n = this.data,
            i = n.currentInfo,
            s = (n.animalList, n.depotList, a.util.getNewUrl("entry/wxapp/game", "kejia_farm_plugin_play"));
        a.util.request({
            url: s,
            data: {
                op: "joinBag",
                ...
                uniacid: t,
                adopt_id: i.id,
                uid: wx.getStorageSync("kejia_farm_uid")
            },
            success: function (a) {
    ...
    sale: function (a) {
        var t = [a.currentTarget.dataset.id, this.data.depotList],
            e = t[0],
            n = t[1].find(function (a) {
                return a.id === e
            });
    ...
    post: function () {
        var a = this.data,
            t = (a.currentAnimal, a.depotList, this),
            e = this.data.currentAnimal.id;
        wx.navigateTo({
            url: "/kejia_farm/pages/user/confirmOrder/index?adopt_id=" + e,
            success: function () {
                t.setData({
                    state: 0
                })
    ...
    saleAll: function () {
        var a = this.data.currentAnimal,
            t = (a.price * a.weight).toFixed(2);
        this.setData({
            state: 3,
            saleMoney: t
        })
    ...
    sureUpdate: function () {
        var a = this.data.sureUpdate,
            t = wx.getStorageSync("kejiaPlaySet"),
            e = this.data.maxPasture;
        this.setData({
            sureUpdate: !a,
