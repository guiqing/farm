...
Page({
    data: {
        ...
        withdrawSet: [],
        user: [],
        kejiaFarmSet: wx.getStorageSync("kejia_farm_setData")
    },
    onLoad: function (e) {
        var n = this;
        a.util.setNavColor(t);
        var o = wx.getStorageSync("kejia_farm_uid"),
            r = a.util.getNewUrl("entry/wxapp/withdraw", "kejia_farm_plugin_play");
        a.util.request({
            url: r,
            data: {
                op: "calculateMoney",
