var t = new getApp,
    ...
    a = t.util.getNewUrl("entry/wxapp/pt", "kejia_farm_plugin_pt");
Page({
    data: {
        types: [{
            id: 1,
    ...
    deleteItem: function (t) {
        var n = this,
            i = t.currentTarget.dataset.orderid,
            d = this.data.orderList,
            r = wx.getStorageSync("kejia_farm_uid");
        wx.showModal({
            title: "提示",
            content: "确认删除该订单吗？",
            success: function (t) {
                t.confirm && t.util.request({
                    url: a,
                    data: {
                        op: "deletePtOrder",
                        action: "index",
    ...
    nowPay: function (n) {
        var i = n.currentTarget.dataset.orderid,
            d = t.util.getNewUrl("entry/wxapp/pay", "kejia_farm_plugin_pt");
        t.util.request({
            url: d,
            data: {
                orderid: i,
    ...
    confirmGoods: function (t) {
        var n = this,
            ...
            d = t.currentTarget.dataset.orderid;
        wx.showModal({
            title: "提示",
            content: "确认您已经收到货了吗？",
            success: function (t) {
    ...
    toComment: function (t) {
        var e = t.currentTarget.dataset.orderid;
        wx.navigateTo({
            url: "/kejia_farm/pages/shop/comment/index?order_id=" + e + "&module_name=kejia_farm_plugin_pt"
        })
    }
});